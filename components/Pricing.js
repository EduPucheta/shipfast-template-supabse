                ...
                <div className="relative flex flex-col h-full gap-5 lg:gap-8 z-10 bg-base-100 p-8 rounded-lg">
                  ...
                  <ul className="space-y-4">
                    ...
                    {plan.features.map((feature, i) => {
                      const featureText = t(feature.name);
                      const isFeatureSuggestionPriority = feature.name === "pricing.plans.free.features.4";
                      ...
                      return (
                        <li key={i} className="flex items-center gap-2">
                          ...
                          {isFeatureSuggestionPriority ? (
                            <span 
                              className="tooltip underline cursor-pointer"
                              data-tip={t('pricing.featureSuggestionPriorityTooltip')}
                            >
                              {featureText}
                            </span>
                          ) : (
